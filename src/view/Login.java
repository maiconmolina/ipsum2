...
public class Login extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if (!(Util.isNullOrEmpty(jTextField1.getText())
                || Util.isNullOrEmpty(Util.CharArrayToString(jPasswordField1.getPassword())))) {
            ...
            JOptionPane.showMessageDialog(this, "Campos não podem ser vazios!");
        }
